...
\outcome{Identify spaces of functions that are vector spaces}
\outcome{Compute inner products of functions using integrals}
\outcome{Determine if functions are orthogonal with respect to this inner product.}
