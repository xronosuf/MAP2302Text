...
%%%%%%%%%%
%   This problem needs to be workshopped.
%       Not confident for item 3 being correctly interpretted as hyperbolic sine.
%%%%%%%%%%
\begin{exercise}
    Solve:
    \begin{itemize}
        ...
        \item $\dfrac{d^2y}{dx^2} = 4 y, \quad y(0)=0, \quad y'(0)=1$
            \[
                \answer{\frac{1}{2}\sinh(h) = \frac{1}{4}e^{2x} - \frac{1}{4}e^{-2x}}% Could also set this up as $\frac{\sinh(h)}{2} = \answer{\frac{1}{4}e^{2x} - \frac{1}{4}e^{-2x}}$
            \]
...
\begin{exercise}
    ...
    \[
        x = \answer[id=test,validator=multiAns]{[2\cos(t),2\sin(t),2\tan(t),22t^2,3e^\pi]}%% Don't think this will actually work yet due to the square brackets. Should look into this more.
    \]
\end{exercise}
%\comboSol{%
%}
