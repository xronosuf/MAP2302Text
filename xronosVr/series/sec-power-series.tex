...
if $\lvert x - x_0 \rvert < \frac{1}{A}$,
and diverges if $\lvert x - x_0 \rvert > \frac{1}{A}$.  That is,
the radius of convergence is $\frac{1}{A}$.
...
is $\infty$.  Otherwise, the radius of convergence is $\frac{1}{A}$.
\pagebreak[3]
\end{theorem1}
