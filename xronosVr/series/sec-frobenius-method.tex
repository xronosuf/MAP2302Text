...
\end{equation*}
Therefore $r= \frac{1}{2}$, or in other words $y = x^{1/2}$.
...
equation has a double root at $r = \frac{1}{2}$.
...
a_k
=
\frac{4 (k+\frac{1}{2}-1) + 2}{4 (k+\frac{1}{2})\,(k+\frac{1}{2}-1) + 1} \, a_{k-1}
=
\frac{1}{k} \, a_{k-1} .
\end{equation*}
...
and multiples of $\frac{1}{2}$ are most important in applications.
